...
class BeamPulseSubsystem:
    ...
    def __init__(self, parent_frame=None, port: str = None, unit: int = 1, baudrate: int = 115200, timeout: int = 1, logger=None, debug: bool = False):
        ...
        self.frequency_hz = tk.DoubleVar(value=100.0)  # Reduced from 1000 for better fit
        self.wave_amplitude = tk.DoubleVar(value=1.5)  # Reduced from 5.0 to fit in 5cm range
